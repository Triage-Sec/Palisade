#!/usr/bin/env bash
# Build the tool guard Docker image and push it to ECR.
#
# Usage:
#   ./services/tool_guard/scripts/create_docker.sh <VERSION>
#
# Example:
#   ./services/tool_guard/scripts/create_docker.sh 0.1.0
#
# Requires:
...
ECR_REPO="palisade-tool-guard"

echo "=== Building palisade-tool-guard ==="
...
# Build from repo root (Dockerfile needs services/tool_guard/ and proto/ directories).
docker build \
  -f services/tool_guard/deploy/Dockerfile \
